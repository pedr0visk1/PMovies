...
containerTrendingMovies.addEventListener("mousemove", (e) => {
    ...
    if (mouseX < boundingRect.left + threshold) {
        scrollDirectionTrendingMovies = -2; // Scroll para a esquerda
        ...
        scrollDirectionTrendingMovies = 2; // Scroll para a direita
...
function autoScrollTrendingMovies() {
    if (scrollDirectionTrendingMovies !== 0) {
        containerTrendingMovies.scrollLeft += scrollDirectionTrendingMovies * 4; // Ajuste a velocidade (5 = rápido)
    }
}
